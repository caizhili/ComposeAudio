...
public class DecodeEngine {
    ...
    public void beginDecodeMusicFile(String musicFileUrl, String decodeFileUrl, int startSecond,
        ...
        final boolean decodeResult = decodeMusicFile(musicFileUrl, decodeFileUrl, startSecond, endSecond, handler, decodeOperateInterface);
...
//                endSecond, handler, decodeOperateInterface);
        getDecodeData(mediaExtractor, mediaCodec, decodeFileUrl, 16000, 1,
                startSecond,
                endSecond, handler, decodeOperateInterface);
        return true;
    }
        ...
        while (!decodeOutputEnd) {
            ...
            try {
                ...
                if (outputBufferIndex < 0) {
                    switch (outputBufferIndex) {
                        ...
                        case MediaCodec.INFO_OUTPUT_FORMAT_CHANGED:
                            ...
                            sampleRate = outputFormat.containsKey(MediaFormat.KEY_SAMPLE_RATE) ? outputFormat.getInteger(MediaFormat.KEY_SAMPLE_RATE) : sampleRate;
                ...
                if (sourceByteArray.length > 0 && bufferedOutputStream != null) {
                    ...
                    byte[] resultByteArray = ConvertChannelNumber(channelCount, Constant.RecordChannelNumber, Constant.RecordByteNumber, convertByteNumberByteArray);
